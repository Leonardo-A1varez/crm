-- Elimina una variable muerta detectada por plpgsql_check. La definición se
-- repite completa porque la migración anterior ya fue aplicada y el historial
-- de migraciones es inmutable.
